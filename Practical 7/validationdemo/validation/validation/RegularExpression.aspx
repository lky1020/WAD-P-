...
<body>
    ...
    <p>
        Name:&nbsp;
        <asp:TextBox ID="txtName" runat="server" Width="234px" CausesValidation="True"></asp:TextBox>
        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" 
            ControlToValidate="txtName" ErrorMessage="[abcd]{0,10}" 
            ValidationExpression="[abcd]{0,10}"></asp:RegularExpressionValidator>
    </p>
    <br />
